...
export default class AssetDetail extends React.Component<any, any> {
    ...
    testAsset = new Asset(
        ...
        ["Private Roof Deck", "Common Roof Deck", "Exposed Brick", "Hardwood Floors", "High Ceilings", "Elevator", "Washer / Dryer in Unit", "Central AC"],
    ...
    render() {
        return (
            <Container>
                <Summary data={this.testAsset} />
                <Divider />
                <Detail data={this.testAsset} />
            </Container>
        );
    }
}
