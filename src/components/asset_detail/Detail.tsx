                    ...
                    <StatusContainer>
                        <Status>
                            ...
                            <StatusItem>
                                ...
                                <StatusContent>
                                    {data.buildingInformation.nRooms}
                                </StatusContent>
                            </StatusItem>
                            <StatusItem>
                                <StatusCategory>
...
const Thumbnail = styled.img.attrs(props => ({
    src: "https://d3mi7e2vp4lzjl.cloudfront.net/LISTING_EDITOR/putImages/a556ec7f-d697-459a-85ee-943a77acc8be/33410b94-f019-49a3-a74e-375586a4fa51/1500x1000.jpg"
}))`
  width: 100%;
  height: 624px;
`;
