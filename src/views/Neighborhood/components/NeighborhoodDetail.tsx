...
const NeighborhoodDetail = ({ match }: RouteComponentProps<MatchParams>) => {
    ...
    return (
        <Container>
            <State>
                {neighborhoodItem?.state}
            </State>
            <RegionName>
                {neighborhoodItem?.regionName}
            </RegionName>
            <ImageContainer background={neighborhoodItem?.thumbnailUrl} />
            <Intro>
                {neighborhoodItem?.intro}
            </Intro>
            <GoToSaleButton onClick={onClickGoToSaleButton}>Homes for Sale in {neighborhoodItem?.regionName}</GoToSaleButton>
            <Map>
