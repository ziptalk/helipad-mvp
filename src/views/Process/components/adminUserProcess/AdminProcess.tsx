...
const AdminProcess = ({ match }: RouteComponentProps<MatchParams>) => {
  ...
  const addButtonOnClick = () => {
    ...
    tmpDataset.process[hoverState[0]].task.splice(
      hoverState[1] + 1,
      0,
      tmpTask
    );
    ...
    setDescription(
      processes.process[hoverState[0]].task[hoverState[1] + 1].description
    );
  ...
  const editButtonOnClick = () => {
    ...
    if (testValue == "[object Object]") {
      ...
      setDeadline(new Date(parseInt(testValue) * 1000));
      if (
        processes.process[hoverState[0]].task[hoverState[1]].doneDate !=
        undefined
      ) {
        testValue2 =
          processes.process[hoverState[0]].task[
                          ...
                          <>
                            {editState[0] == index && editState[1] == index2 ? (
                              ...
                              >
                                {hoverState[0] == index &&
                                hoverState[1] == index2 ? (
                                  <AddCircle onClick={addButtonOnClick}>
                                    +
                                  </AddCircle>
                                ) : (
                                  <SemiCircle />
