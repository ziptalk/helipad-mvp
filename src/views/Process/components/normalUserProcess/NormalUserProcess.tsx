                    ...
                    {processes.process.map((group, index) => (
                        <>
                            ...
                            {group.task.map((tasks, index2) => (
                                    ...
                                    <div style={{display:"flex", justifyContent:"space-between"}}>
                                        <div style={{width: "80%"}}>
                                            <div style={{display:"flex"}}>
                                                {tasks.agent == "BUYER" ? <AgentBox style={{backgroundColor:"#3F8EB0", height:"28px", marginBottom:"15px"}}><CgProfile style={{marginRight:"3px"}}/><AgentInput>{agent}</AgentInput></AgentBox> : <>
                                                {tasks.agent == "HELIPAD" ? <AgentBox style={{backgroundColor:"#B69142", height:"28px", marginBottom:"15px"}}><CgProfile style={{marginRight:"3px"}}/><AgentInput>{agent}</AgentInput></AgentBox> : 
                                                <AgentBox style={{backgroundColor:"#CE723E", height:"28px", marginBottom:"15px"}}><CgProfile style={{marginRight:"3px"}}/><AgentInput>{agent}</AgentInput></AgentBox>}
                                                </>}
                                            </div>
                                            ...
                                            <DeadlineContainer>
                                                ...
                                                <>
                                                    ...
                                                    <div style={{marginLeft:"16px", color:"#359545"}}>
                                                        ...
                                                        <div style={{fontSize:"16px", fontWeight:500, marginTop:"-5px"}}>{deadline}</div>
                                                    </div>
                                                </>
                                                :
                                                <>
                                                    <FiCalendar style={{fontSize:"25px", fontWeight:100, color:'#F15524'}}/>
                                                    <div style={{marginLeft:"13px", color:"#F15524"}}>
                                                        <div style={{fontSize:"10px"}}>Deadline</div>
                                                        <div style={{fontSize:"16px", fontWeight:500, marginTop:"-5px"}}>{deadline}</div>
                                                    </div>
                                                </>
                                        ...
                                        <ButtonBoxContainer style={{textAlign:"right", marginLeft:"30%"}}>
                                            {!done ? <BsCheck onClick={handleDoneOnChange} style={{fontSize:"90px", marginLeft:"20px", marginTop:"5px", width:"100%"}}/> : <BsCheck onClick={handleDoneOnChange} style={{fontSize:"90px", marginLeft:"20px", marginTop:"5px", width:"100%", color:"green"}}/>}
                                        </ButtonBoxContainer>
                                    </div>
                                </EditContainer>
                                </div>
                                ...
                                :
                                    <TaskContainer onClick={editButtonOnClick} onMouseEnter={()=>handleMouseHover(index, index2)}>
                                        <SemiCircle />
                                        <SemiLine />
